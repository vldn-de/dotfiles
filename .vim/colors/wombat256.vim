...
hi Title		ctermfg=7		ctermbg=none	cterm=none		guifg=#f6f3e8	guibg=NONE		gui=none
...
hi MatchParen	ctermfg=7		ctermbg=243		cterm=none		guifg=#f6f3e8	guibg=#857b6f	gui=none
